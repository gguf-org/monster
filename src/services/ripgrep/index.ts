...
export async function regexSearchFiles(
	...
	// Filter results using CoderIgnoreController if provided
	const filteredResults = coderIgnoreController
		? results.filter((result) => coderIgnoreController.validateAccess(result.filePath))
		: results

...
// import { OcaHandler } from "./providers/oca" // REMOVED - OCA provider not needed
...
function createHandlerForProvider(
	...
	case "aihubmix":
		...
		case "custom-config":
			return new OpenAiHandler({
				onRetryAttempt: options.onRetryAttempt,
				openAiApiKey: "custom-config", // dummy key as it's typically unused for local/custom endpoints requesting only base url
				openAiBaseUrl: options.customConfigBaseUrl,
				openAiModelId: mode === "plan" ? options.planModeCustomConfigModelId : options.actModeCustomConfigModelId,

export const AUDIO_PROGRAM_CONFIG = {
	darwin: {
		...
		installDescription: "FFmpeg is a multimedia framework that Coder uses to record audio from your microphone.",
	},
	linux: {
		command: "ffmpeg",
	...
	win32: {
		...
		getArgs: (outputFile: string, deviceName: string = "default") => [
			"-f",
			"dshow",
			"-i",
			`audio=${deviceName}`,

...
export const BANNER_DATA: BannerCardData[] = [
	// Info banner with inline link
	{
		id: "info-banner-v1",
		icon: "lightbulb",
		title: "Use Coder in Right Sidebar",
		description:
			"For the best experience, drag the Coder icon to your right sidebar. This keeps your file explorer and editor visible while you chat with Coder, making it easier to navigate your codebase and see changes in real-time.",
	},

...
export const BASE_SLASH_COMMANDS: SlashCommand[] = [
	...
	{
		name: "newrule",
		description: "Create a new Coder rule based on your conversation",
		section: "default",
		cliCompatible: true,
	},
	{
		name: "reportbug",
		description: "Create a Github issue with Coder",
		section: "default",
		cliCompatible: true,
	},
	{
	...
	{
		name: "subagent",
		description: "Invoke a Coder CLI subagent for focused research tasks",
		section: "default",
		cliCompatible: true,
	},
]

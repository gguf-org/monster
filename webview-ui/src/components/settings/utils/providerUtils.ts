...
export function normalizeApiConfiguration(
	...
	switch (provider) {
		...
		case "custom-config":
			const customConfigModelId =
				currentMode === "plan" ? apiConfiguration?.planModeCustomConfigModelId : apiConfiguration?.actModeCustomConfigModelId
			return {
				selectedProvider: provider,
				selectedModelId: customConfigModelId || "",
...
export function getModeSpecificFields(apiConfiguration: ApiConfiguration | undefined, mode: Mode) {
	...
	return {
		...
		customConfigModelId:
			mode === "plan" ? apiConfiguration.planModeCustomConfigModelId : apiConfiguration.actModeCustomConfigModelId,
...
export async function syncModeConfigurations(
	...
	switch (apiProvider) {
		...
		case "aihubmix":
			...
			break
		case "custom-config":
			updates.planModeCustomConfigModelId = sourceFields.customConfigModelId
			updates.actModeCustomConfigModelId = sourceFields.customConfigModelId
			break

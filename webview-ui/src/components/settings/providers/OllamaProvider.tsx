		...
		<div className="flex flex-col gap-2">
			...
			<p
				...
				<span style={{ color: "var(--vscode-errorForeground)" }}>
					(<span style={{ fontWeight: 500 }}>Note:</span> Coder uses complex prompts and works best with Claude models.
					Less capable models, i.e., gpt-oss:20b, might not work as expected; please do your own research.)
				</span>
			</p>
		</div>
	)

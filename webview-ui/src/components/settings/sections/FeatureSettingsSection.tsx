				...
				<div style={{ marginBottom: 20 }}>
					...
					{/* {isMacOSOrLinux() && PLATFORM_CONFIG.type === PlatformType.VSCODE && (
						<div
							...
							<p className="text-xs mt-1 mb-0">
								<span className="text-success">Experimental: </span>{" "}
					...
					{focusChainSettings?.enabled && (
						<div style={{ marginTop: 10, marginLeft: 20 }}>
							...
							/>
							<p className="text-xs mt-[5px] text-(--vscode-descriptionForeground)">
								Interval (in messages) to remind coder about its focus chain checklist (1-100). Lower values
					...
					{clineWebToolsEnabled?.featureFlag && (
						<div style={{ marginTop: 10 }}>
							<VSCodeCheckbox
								...
								Enable Coder Web Tools
							</VSCodeCheckbox>
							<p className="text-xs text-(--vscode-descriptionForeground)">
								Enables websearch and webfetch tools while using the coder provider.
							</p>
						</div>
					)}
					<div className="mt-2.5">
					...
					{multiRootSetting.featureFlag && (
						<div className="mt-2.5">
							...
							<p className="text-xs">
								<span className="text-success">Experimental: </span>{" "}
								<span className="text-description">Allows coder to work across multiple workspaces.</span>
							</p>
						</div>
					)}
					<div className="mt-2.5">
						...
						{!isMacOSOrLinux() ? (
							...
							<p className="text-xs">
								<span className="text-success">Experimental: </span>{" "}
								<span className="text-description">
									Allows execution of hooks from .coder/hooks/ directory.
								</span>
							</p>
						)}
					</div>
					<div className="mt-2.5">
						...
						<p className="text-xs">
								<span className="text-success">Experimental: </span>{" "}
							<span className="text-description">
								Enables Skills for reusable, on-demand agent instructions from .coder/skills/ directories (compatible with .cline/skills and .claude/skills).
							</span>
						</p>
					</div>
					<div style={{ marginTop: 10 }}>
						...
						<p className="text-xs text-success">
							EXPERIMENTAL & DANGEROUS: This mode disables safety checks and user confirmations. Coder will

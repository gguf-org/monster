...
export const STEP_CONFIG = {
	0: {
		...
		buttons: [
			...
			{ text: "Login to Coder", action: "signin", variant: "secondary" },
		],
	},
	[NEW_USER_TYPE.FREE]: {
...
export const USER_TYPE_SELECTIONS: UserTypeSelection[] = [
	...
	{ title: "Bring my own API key", description: "Use Coder with your provider of choice", type: NEW_USER_TYPE.BYOK },
]

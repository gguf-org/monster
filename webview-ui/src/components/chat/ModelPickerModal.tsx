...
import { getModelsForProvider, getProviderInfo, filterOpenRouterModelIds, normalizeApiConfiguration, getModeSpecificFields, syncModeConfigurations } from "@/components/settings/utils/providerUtils"
...
const ModelPickerModal: React.FC<ModelPickerModalProps> = ({ isOpen, onOpenChange, currentMode, children }) => {
	...
	// Filtered models - for OpenRouter/Vercel show all by default

...
const PLAN_MODE_COLOR = "var(--vscode-editor-foreground)"
const ACT_MODE_COLOR = "var(--vscode-editor-foreground)"
...
padding: `9px 48px ${9 + thumbnailsHeight}px 9px`,
						}}
					/>
					<DynamicTextArea
						autoFocus={true}
...
padding: `9px 48px 9px 9px`,
					...
					<div
						...
						<div className="flex flex-row items-center">
							{/* Always show VoiceRecorder as per user request */}
							<VoiceRecorder
				...
				<div className="flex justify-between items-center -mt-[2px] px-3 pb-2">
					...
					<Tooltip>
						<TooltipContent
							...
							side="top">
							{`In ${shownTooltipMode === "act" ? "Act" : "Plan"}  mode, Coder will ${shownTooltipMode === "act" ? "complete the task immediately" : "gather information to architect a plan"}`}
								...
								{["Plan", "Act"].map((m) => (
									<div
										...
										className={cn(
											...
											mode === m.toLowerCase()
												? "text-[var(--vscode-editor-background)]"
